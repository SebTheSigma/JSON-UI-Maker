...
export declare const GLOBAL_ELEMENT_MAP: Map<string, DraggableButton | DraggableCanvas | DraggablePanel | DraggableCollectionPanel | DraggableLabel | DraggableScrollingPanel>;
...
export declare class Builder {
    static generateAndCopyJsonUI(): void;

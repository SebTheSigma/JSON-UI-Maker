...
export class MinecraftSlider {
    ...
    updateHandle() {
        ...
        this.handleCanvas.drawImage(this.scrollBarWidth, this.backgroundBar.clientHeight * (this.scrollingPanel.panel.clientHeight / this.scrollingPanel.panel.scrollHeight));

 ...
 */
export declare function buttonDataToJavaScript(buttons: FormButtonData[]): string;
/**
 ...
 */
export declare function buttonDataToTypeScript(buttons: FormButtonData[]): string;
